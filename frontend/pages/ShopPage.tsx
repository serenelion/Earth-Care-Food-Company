    ...
    return (
      <div className="min-h-screen bg-cream-50 flex items-center justify-center pt-20">
        <div className="text-center">
          ...
          <p className="text-earth-700 text-lg">Loading current menu...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-cream-100 pt-32 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-6xl font-serif font-bold text-earth-800 mb-6">
            Current Menu
          </h1>
          ...
          <p className="text-earth-700 font-semibold">
            Subscribe to our newsletter to be notified when new medicine becomes available.
          </p>
        </div>
        ...
        {products.length === 0 && (
          <div className="text-center py-20">
            <p className="text-earth-600 text-lg">No products available at the moment. Check back soon!</p>
          </div>
        )}
      </div>
    </div>
